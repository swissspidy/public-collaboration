...
require_once __DIR__ . '/includes/class-redirected.php';
require_once __DIR__ . '/includes/trait-intercepts-redirects.php';
...
function _manually_load_plugin(): void {
	require dirname( __DIR__, 2 ) . '/public-collaboration.php';
}
